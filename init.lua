...
-- Replace all occurences of words under cursor
vim.api.nvim_set_keymap("n", "<leader>ra", ":%s/<C-r><C-w>/<C-r><C-w>/gc<C-f>$F/i<CR>", { noremap = true })
-- Go Formatter
vim.api.nvim_set_keymap("n", "<leader>G", ":GoFmt<CR>", { noremap = true })
-- Little Linter
